#!/usr/bin/env node
/**
 * Add skills from batch 5: davepoon, ChrisWiles, czlonkowski
 */
...
const REPOS = [
  { owner: "davepoon", repo: "buildwithclaude", stars: 2150 },
  { owner: "ChrisWiles", repo: "claude-code-showcase", stars: 2153 },
  { owner: "czlonkowski", repo: "n8n-skills", stars: 1373 },
];
...
async function addBatch5() {
  console.log(`🚀 Adding Batch 5: More community repositories\n`);
